...
```markdown
[![CI Status](https://github.com/mcp-sim/mcp-sim-starter-kit/actions/workflows/test.yml/badge.svg)](https://github.com/mcp-sim/mcp-sim-starter-kit/actions/workflows/test.yml)
```
