...
See [Schema Spec](../04-schema-spec) for versioning rules.
...
Feel free to [open an issue on GitHub](https://github.com/mcp-sim/mcp-sim-starter-kit/issues) or reach out to our team.