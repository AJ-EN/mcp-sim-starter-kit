...
You can create custom templates by forking the [official template repository](https://github.com/<your-org>/template-node) and modifying:
...
|--------------------|-------------------------------|----------------------------------------------------|
| `MCP_TEMPLATE_URL` | Default template repository   | `https://github.com/mcp-sim/template-node`         |
